...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.80\textwidth]{czasobs(time).png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.80\textwidth]{czasobs(ilosc).png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.80\textwidth]{czasobs(ilosc)2.png}
	\caption{Zależność czasu obsługi skrzyżowania od ilości początkowej samochodów}	
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.80\textwidth]{dzialanie2.png}
	\caption{Zależność czasu obsługi skrzyżowania od ilości początkowej samochodów}	
	\label{dzialanie2}
\end{figure}
